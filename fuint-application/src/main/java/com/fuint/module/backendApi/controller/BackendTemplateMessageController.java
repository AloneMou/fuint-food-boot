 ...
 */
@Api(tags="管理端-公众号模板消息相关接口")
@RestController
@AllArgsConstructor
@RequestMapping(value = "/backendApi/templateMessage")
public class BackendTemplateMessageController extends BaseController {
    ...
    @CrossOrigin
    @PreAuthorize("@pms.hasPermission('templateMessage:index')")
    public ResponseObject list(HttpServletRequest request) throws BusinessCheckException {
        ...
        for (WxMessageEnum wxMessageEnum : WxMessageEnum.values()) {
            ...
            MtSetting setting = settingService.querySettingByName(accountInfo.getMerchantId(), SettingTypeEnum.TEMP_MESSAGE.getKey(), wxMessageEnum.getKey());
    ...
    @CrossOrigin
    @PreAuthorize("@pms.hasPermission('templateMessage:edit')")
    public ResponseObject saveHandler(HttpServletRequest request, @RequestBody Map<String, Object> param) {
        ...
        try {
            ...
            // 保存配置
            settingService.removeSetting(accountInfo.getMerchantId(), SettingTypeEnum.TEMP_MESSAGE.getKey(), key);
            MtSetting info = new MtSetting();
            info.setMerchantId(accountInfo.getMerchantId());
            info.setType(SettingTypeEnum.TEMP_MESSAGE.getKey());
            info.setName(key);
            info.setValue(json);
            info.setMerchantId(accountInfo.getMerchantId());
            info.setStoreId(0);
