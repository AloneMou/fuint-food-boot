...
public interface MemberService extends IService<MtUser> {
     ...
     *
     * @param merchantId 商户ID
     * @param unionId    会员unionId
     * @return
     * @throws BusinessCheckException
     */
    MtUser queryMemberByUnionId(Integer merchantId, String unionId) throws BusinessCheckException;
     ...
     * @throws BusinessCheckException
     */
    MtUser queryMemberByMpOpenId(Integer merchantId, String mpOpenId) throws BusinessCheckException;
