package com.fuint.repository.utils;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParams pageParam) {
        ...
        if (CollUtil.isNotEmpty(sortingFields)) {
            for (SortingField sortingField : sortingFields) {
                if (SortingField.ORDER_ASC.equals(sortingField.getOrder())){
                    page.setAsc(StrUtil.toUnderlineCase(sortingField.getField()));
                }else{
                    page.setDesc(StrUtil.toUnderlineCase(sortingField.getField()));
                }
            }
        }
        return page;
